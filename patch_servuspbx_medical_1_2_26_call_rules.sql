-- ============================================================
-- ServusPBX Medical 1.2.26
-- Anrufregeln / Eingehender Callflow
-- ============================================================

CREATE TABLE IF NOT EXISTS `spbx_call_rules` (
...
CREATE TABLE IF NOT EXISTS `spbx_call_rule_time_windows` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_rule_order` (`rule_id`,`sort_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `spbx_settings` (`setting_key`, `setting_value`, `description`) VALUES
('call_rules_version', '1.2.26', 'Anrufregeln pro Rufnummer mit Zeitfenstern, Feiertagen und Closed-Aktion'),
